...
// Static overview — reads the baked data/h8/dashboard.json (same source as the
// other H-8 pages). The live-from-Postgres version is deferred to Phase D; the
// Prisma-multi-query-in-RSC hang on the standalone runtime needs dedicated
// debugging time and the live dashboard is not on the inventory-build path.
