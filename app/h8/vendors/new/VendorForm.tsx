  ...
  return (
    <form onSubmit={submit} className="max-w-2xl bg-white border border-slate-200 rounded-lg shadow-sm p-6 space-y-4">
      ...
      <details className="border-t border-slate-100 pt-4">
        <summary className="text-sm font-medium text-slate-700 cursor-pointer">Payment rails (optional)</summary>
        <div className="grid grid-cols-2 gap-4 mt-3">
      ...
      <div className="flex gap-3">
        <button type="submit" disabled={busy} className="px-4 py-2.5 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 disabled:bg-blue-400">{busy ? "Saving…" : "Save vendor"}</button>
